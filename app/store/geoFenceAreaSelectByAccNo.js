...
Ext.define('MyGPS.store.geoFenceAreaSelectByAccNo', {
    extend: 'Ext.data.Store',
    alias: 'store.geoFenceAreaSelectByAccNo',
    config: {
        ...
        proxy: {
            ...
            type: 'ajax',
            url: document.location.protocol + '//' + document.location.host + '/API/GeoFenceArea/GeoFenceAreaSelectByAccountNo',
            actionMethods: {
                read: 'GET'
            },
