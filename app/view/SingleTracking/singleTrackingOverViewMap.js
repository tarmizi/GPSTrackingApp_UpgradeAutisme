...
function SetbtnsingleTrackingOverViewMapPointInfoTbl(TrackItem, DateDT, APN, TrackID, Speed, Altitude, BatteryReading, VBoundaryStatus, Interval, GSMSignalReading)
{
    //if (APN.length)
    var PointMode='GPS';
    var strAPN = APN;
    ...
    Ext.getCmp('btnsingleTrackingOverViewMapPointInfoTbl').setHtml('<div class="transbox"><table class="tblgpssummary">  <tr> <td colspan="2" style="background-color: transparent;  font-size: 12px; color: #fff; text-align: center;  valign:top; height:20%">' + TrackItem + '</td><td  style="background-color: transparent;  font-size: 12px; color: #fff; text-align: center;  valign:top; height:20%">' + DateDT + '</td> <td  style="background-color: transparent;  font-size: 12px; color: #fff; text-align: center;  valign:top; height:20%">' + PointMode + '</td></tr><tr> <td colspan="2" style="background-color: transparent;  font-size: 9px; color: #fff; text-align: center;  valign:top;  height:20% ">' + TrackID + '</td> <td  style="background-color: transparent;  font-size: 9px; color: #fff; text-align: center;  valign:top; height:20%">Signal Time</td>   <td  style="background-color: transparent;  font-size: 9px; color: #fff; text-align: center;  valign:top; height:20%">Point Mode&nbsp;&nbsp;&nbsp;</td>   </tr>   <tr > <td class="tdstreetViewTblInfo">' + Speed + 'KM/H</td> <td class="tdstreetViewTblInfo">' + BatteryReading + '%</td> <td class="tdstreetViewTblInfo">' + GSMSignalReading + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + Altitude + '</td><td class="tdstreetViewTblInfo3">' + Interval + '(s)</td></tr> <tr > <td class="tdstreetViewTblInfo1">Curr. Speed</td> <td class="tdstreetViewTblInfo1">Battery Level</td> <td class="tdstreetViewTblInfo1">GSM intensity&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Altitude</td><td class="tdstreetViewTblInfo1">Interval&nbsp;&nbsp;&nbsp;</td></tr>  </table></div>');
