...
Ext.define('MyGPS.store.TrackingHistoryMap.TrackingHistoryMapStore', {
    extend: 'Ext.data.Store',
    alias: 'store.TrackingHistoryMapStore',
    config: {
        model: 'MyGPS.model.TrackingHistory.TrackingHistoryModel',
        autoLoad: false,
